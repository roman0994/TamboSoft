    ...
    public class Animal_Datos : Conexion
    {
        public List<Animal> RecuperarTodos()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    animal.Caravana = dr.IsDBNull(17) ? string.Empty : dr["caravana"].ToString();
        ...
        public List<Animal> RecuperarPorTambo(int id_tambo)
        {
            try
            {
                List<Animal> lista = new List<Animal>();
                this.AbrirConexion();
                SqlCommand cmdAnimal = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal, " +
                                                      " a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.id_tambo,a.id_raza," +
                                                      " r.nombre_raza,t.nombre_tambo,a.habilitado,a.caravana " +
                                                      " FROM Animal a inner join Raza r on a.id_raza=r.id_raza " +
        ...
        public List<Animal> RecuperarVacasPorTambo(int id_tambo)
        {
            try
            {
                List<Animal> lista = new List<Animal>();
                this.AbrirConexion();
                SqlCommand cmdAnimal = new SqlCommand("SELECT distinct a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal, " +
                                                    " a.estado_animal,a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre, " +
                                                    " a.id_tambo,a.id_raza,r.nombre_raza,t.nombre_tambo,a.habilitado,a.caravana " +
                                                    " FROM Animal a " +
                                                    " inner join Raza r on a.id_raza=r.id_raza " +
                                                    " inner join Tambo t on a.id_tambo=t.id_tambo " +
                                                    " where a.id_tambo=@id_tambo and a.habilitado='true' and a.estado_animal!='Vendido' " +
                                                    " and a.estado_animal !='Muerto' and a.categoria='Vaca' " +
                                                    " order by a.rp asc", Conn);
                cmdAnimal.Parameters.Add("id_tambo", SqlDbType.Int).Value = id_tambo;
        ...
        public DataTable RecuperarDTPorTambo(int id_tambo)
        {
            this.AbrirConexion();
            SqlCommand cmdAnimal = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal, " +
                                                    "a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.id_tambo, " +
                                                    "a.id_raza,r.nombre_raza,t.nombre_tambo,a.habilitado,a.caravana " +
                                                    " FROM Animal a inner join Raza r on a.id_raza=r.id_raza " +
                                                    " inner join Tambo t on a.id_tambo=t.id_tambo " +
                                                    " where a.id_tambo=@id_tambo and a.habilitado='true' " +
                                                    " and a.estado_animal!='Vendido' and a.estado_animal!='Muerto' " +
        ...
        public List<Animal> RecuperarVacasServidasPorTambo(int id_tambo)
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    animal.Caravana = dr.IsDBNull(11) ? string.Empty : dr["caravana"].ToString();
        ...
        public List<Animal> RecuperarAnimalesEnfermosPorTambo(int id_tambo)
        {
            try
            {
                List<Animal> lista = new List<Animal>();
                this.AbrirConexion();
                SqlCommand cmdAnimal = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.nombre_animal,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.estado_animal,r.nombre_raza,t.nombre_tambo,a.caravana FROM Animal a inner join Raza r on a.id_raza=r.id_raza inner join Tambo t on a.id_tambo=t.id_tambo where a.id_tambo=@id_tambo and a.habilitado='true' and a.estado_animal = 'Enfermo' order by a.nombre_animal", Conn);
                cmdAnimal.Parameters.Add("id_tambo", SqlDbType.Int).Value = id_tambo;
        ...
        public Animal RecuperarUno(int rp)
        {
            try
            {
                Animal animal = new Animal();
                this.AbrirConexion();
                SqlCommand cmdAnimal = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal,a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.id_tambo,a.id_raza,r.nombre_raza,t.nombre_tambo,a.habilitado,a.caravana FROM Animal a inner join Raza r on a.id_raza=r.id_raza inner join Tambo t on a.id_tambo=t.id_tambo where a.rp=@rp and a.estado_animal!='Vendido'", Conn);
                ...
                while (drAnimal.Read())
                {
                    ...
                    animal.Caravana = drAnimal.IsDBNull(17) ? string.Empty : drAnimal["caravana"].ToString();
                }
                drAnimal.Close();
                return animal;
        ...
        {
            this.AbrirConexion();
            SqlCommand cmdFiltro = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal,a.hba,a.categoria, " +
        ...
        public DataTable FiltrarPorRP(int rp)
        {
            ...
            cmdFiltro.CommandText = "SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal,a.hba,a.categoria,a.rp_madre, " +
        ...
        {
            this.AbrirConexion();
            SqlCommand cmdFiltro = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal, " +
                                                " a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.id_tambo,a.id_raza,r.nombre_raza, " +
                                                " t.nombre_tambo,a.habilitado,a.caravana " +
                                                " FROM Animal a inner join Raza r on a.id_raza=r.id_raza " +
                                                " inner join Tambo t on a.id_tambo=t.id_tambo " +
                                                " where caravana like ('%" + texto + "%') and a.id_tambo=@idtambo" +
                                                " and a.habilitado='true' and a.estado_animal!='Vendido' " +
                                                " order by Cast(a.caravana as int) asc", Conn);
            cmdFiltro.Parameters.Add("idtambo", SqlDbType.Int).Value = idtambo;
        ...
        {
            this.AbrirConexion();
            SqlCommand cmdAnimal = new SqlCommand("SELECT a.rp,a.fecha_nacimiento,a.edad,a.foto,a.nombre_animal,a.estado_animal,a.hba,a.categoria,a.rp_madre,a.rp_padre,a.hba_madre,a.hba_padre,a.id_tambo,a.id_raza,r.nombre_raza,t.nombre_tambo,a.habilitado,a.caravana FROM Animal a inner join Raza r on a.id_raza=r.id_raza inner join Tambo t on a.id_tambo=t.id_tambo where a.id_tambo=@id_tambo and a.habilitado='true' and a.categoria = 'Vaca'", Conn);
            cmdAnimal.Parameters.Add("id_tambo", SqlDbType.Int).Value = id_tambo;
            SqlDataReader drAnimal = cmdAnimal.ExecuteReader();
        ...
        public int ObtenerUltimaCaravana(int id_tambo)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    numcaravana = Convert.ToInt32(dr["caravana"]);
                }
                dr.Close();
                return numcaravana;
            }
